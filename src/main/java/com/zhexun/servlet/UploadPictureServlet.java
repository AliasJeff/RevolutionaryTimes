...
//                String basePath = req.getRealPath("/images");
                String basePath = this.getServletContext().getRealPath("/images");
...
//                getServletContext().getRequestDispatcher("/index.jsp").forward(req, resp);
                ...
                req.getRequestDispatcher("/postPicture.jsp").forward(req, resp);
            }
        }
    }
